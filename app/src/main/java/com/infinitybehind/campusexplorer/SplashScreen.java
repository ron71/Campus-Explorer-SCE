...
public class SplashScreen extends AppCompatActivity {
    ...
    private void insertionQuerySet(){
        ...
        if(db!=null){
            String querySet =
                    "insert into campus_15 values(0,'Ass.Dean Office','office',20.34836,85.81592,0,'BSP MISHRA');\n" +
                    ...
                    "insert into campus_15 values(25,'F-108','office',20.34799,85.81587,1,'DR. CR PRADHAN');\n" +
                    "insert into campus_15 values(26,'F-109','office',20.34819,85.81008,1,'ANIL KUMAR SWAIN');\n" +
                    ...
                    "insert into campus_15 values(29,'F-117','office',20.34836,85.81592,1,'PK PATTNAIK');\n" +
                    "insert into campus_15 values(30,'Room No. 2','office',20.34836,85.81592,0,'SANTOSH SWAIN');\n" +
                    "insert into campus_15 values(31,'Room No. 3','office',20.34836,85.81592,0,'AK JAGADEV');\n" +
                    "insert into campus_15 values(32,'Room No. 4','office',20.34836,85.81592,0,'MANOJ KR MISHRA');\n" +
                    "insert into campus_15 values(33,'Room No. 5','office',20.34836,85.81592,0,'KUMAR DEVDUTTA');\n" +
                    "insert into campus_15 values(34,'Room No. 6','office',20.34836,85.81592,0,'HARISH PATTNAIK');\n" +
                    "insert into campus_15 values(35,'Room No. 7','office',20.34836,85.81592,1,'SUBHASISH DASH');\n" +
                    "insert into campus_15 values(36,'Room No. 8','office',20.34836,85.81592,1,'ARUP ABHINA ACHARYA');\n" +
                    "insert into campus_15 values(37,'Room No. 9','office',20.34836,85.81592,1,'PRACHET BHUYAN');\n" +
                    "insert into campus_15 values(38,'Room No. 10','office',20.34836,85.81592,1,'ANUJA KR ACHARYA');\n" +
                    "insert into campus_15 values(39,'Room No. 11','office',20.34836,85.81592,1,'SUDAN JHA');\n" +
                    "insert into campus_15 values(40,'Room No. 12','office',20.34836,85.81592,1,'SARITA TRIPATHY');\n" +
                    "insert into campus_15 values(41,'Room No. 13','office',20.34836,85.81592,1,'BHASHWATI');\n" +
                    "insert into campus_15 values(42,'Room No. 14','office',20.34836,85.81592,1,'ROSHNI PRADHAN');\n" +
                    "insert into campus_15 values(43,'Room No. 15','office',20.34834,85.81593,0,'SAMARESH MISHRA');\n" +
                    "insert into campus_15 values(44,'Room No. 16','office',20.34834,85.81593,0,'SHELLY KUMAR KHUNTIA');\n" +
                    ...
                    "insert into campus_15 values(50,'Room No. 22','office',20.34823,85.81595,1,'SK JENA');\n" +
                    "insert into campus_15 values(51,'Room No. 23','office',20.34799,85.81587,0,'SC MOHARANA');\n" +
                    "insert into campus_15 values(52,'Room No. 24','office',20.34826,85.81611,1,'RAJAT KUMAR BEHERA');\n" +
                    "insert into campus_15 values(53,'Room No. 25','office',20.34819,85.81008,0,'SURESH CHANDRA SATPATHY');\n" +
                    "insert into campus_15 values(54,'Room No. 26','office',20.34819,85.81008,0,'BISWAJIT SAHOO');\n" +
                    "insert into campus_15 values(55,'Room No. 27','others',20.34818,85.81603,2,'CIRCULATION CELL');\n" +
